const FAQS = [
  ...
  { q: 'How do grocery reward points work?', a: 'Products worth £50 or more each earn reward points — 5p in reward value for every £50 that item is worth (so a £100 product earns 10p). Points build up in your account and become redeemable for money off once you\'ve accumulated £1.' },
