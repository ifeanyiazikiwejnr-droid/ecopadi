    ...
    <section className="section">
      <div className="wrap" style={{ maxWidth: 720 }}>
        ...
        <div className="faq-list" style={{ marginTop: 56 }}>
          ...
          <details><summary>How do grocery reward points work?</summary><p>Orders worth £50 or more earn reward points — 5p in reward value for every £50 your order is worth. Points build up in your account and become redeemable for money off once you've accumulated £1.</p></details>
        </div>
      </div>
    </section>
  );
